...
/* ./.libs/lt-curl.c - temporary wrapper executable for .libs/curl.exe
...
const char * LIB_PATH_VALUE   = "C:\\msys64\\home\\sxy\\Github\\cpp-qt\\control_tower_system\\common_lib\\third_party_lib\\curl-7.64.0\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C;/msys64/mingw64/lib;C;/msys64/mingw64/bin;/home/sxy/Github/cpp-qt/control_tower_system/common_lib/third_party_lib/curl-7.64.0/lib/.libs;/mingw64/lib;/mingw64/bin;";
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.6 Debian-2.4.6-9\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# curl - temporary wrapper script for .libs/curl.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-9\n", f);
  fputs ("#\n", f);
  fputs ("# The curl program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../lib/libcurl.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"curl.exe:curl:$LINENO: libtool wrapper (GNU libtool) 2.4.6 Debian-2.4", f);
  fputs (".6-9\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"curl.exe:curl:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"curl.exe:curl:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=C:/msys64/mingw64/lib:C:/msys64/mingw64/bin:/home/sxy/Github/cpp-qt/co", f);
  fputs ("ntrol_tower_system/common_lib/third_party_lib/curl-7.64.0/lib/.libs:/mingw64/li", f);
  fputs ("b:/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/sxy/Github/cpp-qt/control_tower_system/common_lib/third_party_l", f);
  fputs ("ib/curl-7.64.0/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
