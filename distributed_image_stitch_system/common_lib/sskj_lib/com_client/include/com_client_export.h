...
int SendHTTPRequestToPort(char server_ip[32], char *input, char *output_type,
                    unsigned char **output, int *buffer_len,int port);
int SendSecretRequestToPort(AuthParam auth_para, char* input, char* output_type,
                      unsigned char** output, int* buffer_len,int port);
